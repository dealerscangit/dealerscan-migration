...
- **OAuth Client allowed Item IDs:** prod + dev — both authorized on the same OAuth Client so end-to-end testing works on the Dev install before production listing approval
